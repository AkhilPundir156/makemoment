...
exports.CardContent = exports.CardDescription = exports.CardTitle = exports.CardFooter = exports.CardHeader = exports.CardAction = exports.Card = void 0;
...
var CardAction = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<div ref={ref} className={(0, utils_1.cn)("flex items-center justify-end gap-2 p-6 pt-0 border-t border-border", className)} {...props}/>);
});
